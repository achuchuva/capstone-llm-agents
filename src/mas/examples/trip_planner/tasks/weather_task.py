...
def do_weather_task(trip_idea: TripIdeaResource) -> WeatherResource:
    ...
    USER_MESSAGE = f"I want to know the weather in {trip_idea.trip_idea.city} on {trip_idea.trip_idea.date} at 12:00."  # User message
    result = location_agent.initiate_chat(
        weather_agent, message=USER_MESSAGE, max_turns=3
    )
    ...
    summary = WeatherResource(WeatherResource.WeatherData(**summary_json))
